...
public class Util {
    ...
    // The below code has been taken from https://www.spigotmc.org/threads/free-code-sending-perfectly-centered-chat-message.95872/
    ...
    public static List<String> addCenteredMessage(String message, List<String> messages){
        if(message == null || message.equals("")) return messages;
